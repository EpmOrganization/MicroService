...
namespace EPM.Core.HttpClientPolly
{
    /// <summary>
    ...
    public static class PollyHttpClientServiceCollectionExtensions
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddPollyHttpClient(this IServiceCollection services, string name, Action<PollyConfig> action)
        {
            // 1、创建选项配置类
